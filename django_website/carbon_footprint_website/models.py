...
class UserFootprintAggregation(models.Model):
    ...
    mean_energy_consumption_footprint = models.FloatField(help_text="mean Carbon footprint from energy consumption",
                                                          default=0)
    mean_meat_consumption_footprint = models.FloatField(help_text="mean Carbon footprint from meat consumption",
                                                        default=0)
    mean_travel_distance_footprint = models.FloatField(help_text="mean Carbon footprint from travel distance",
                                                       default=0)
    mean_waste_production_footprint = models.FloatField(help_text="mean Carbon footprint from waste production",
                                                        default=0)
    mean_total_footprint = models.FloatField(help_text="mean total Carbon footprint generated", default=0)
